...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_weight", type=str, default="dpo", help="模型权重保存前缀")
    ...
    parser.add_argument("--from_weight", type=str, default="full_sft", help="基于哪个模型权重开始训练，为none则从头开始训练")
    ...
    # 初始化参考模型(冻结)
    ref_model, _ = init_model(lm_config, args.from_weight, args.device)
    ref_model.eval()
